...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    supported_files: 'Supported formats: PDF only',
    ...
    error_file_type: 'Unsupported file type. Please upload a PDF file.',
  ...
  ar: {
    ...
    supported_files: 'الصيغ المدعومة: PDF فقط',
    ...
    error_file_type: 'نوع الملف غير مدعوم. يرجى رفع ملف PDF.',
